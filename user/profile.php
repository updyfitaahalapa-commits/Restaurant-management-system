...
<div class="container" style="margin-top: 100px; margin-bottom: 50px;">
    <h2 class="fw-bold mb-4"><i class="fas fa-user-circle text-warning me-2"></i> My Profile</h2>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-warning fw-bold text-dark rounded-pill" name="update_profile">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-dark rounded-pill" name="change_password">
